...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" >
  <head>
    ...
    <div id="wrapper"> <!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
      ...
      <div id="leftNav">
        <?php require($_SERVER['DOCUMENT_ROOT']."/capabilities/3dprint/capabilities_3d_left_nav.php") ?> <!-- Left Navigation in the include file -->
      ...
      <div id="MainContent"> <!-- sets the main content (middle column area) -->
        ...
        <a href="http://www.thingiverse.com/thing:30654"><img src="/capabilities/images/arm.jpg" alt="Robot arm prototype"/></a>

        <h1>3D Printing</h1>
        <h2>Overview</h2>
        <p>The Student Shop has three rapid prototyping machines (a.k.a. 3D printers). These include a Dimension Elite and two RepRaps. All perform <a href="https://en.wikipedia.org/wiki/Fused_deposition_modeling" rel="external">fused deposition modeling</a> with <acronym title="acrylonitrile butadiene styrene">ABS</acronym>. The machines are excellent for prototyping designs that would be cost or time prohibitive to make using conventional machining technologies.</p>
        ...
        <h2><a name="estimates"></a>Printing Requests/Estimates</h2>
        ...
        <p>All printing done by the shop will be done on the Dimension Elite printer. The printing costs can be found on the <a href="/capabilities/3dprint/elite.php#costs">Dimension Elite page</a>. During times of high demand printing will be done on a first come first served basis. Students, faculty, and staff of the College of Engineering will be given priority over individuals outside of the college.</p>
