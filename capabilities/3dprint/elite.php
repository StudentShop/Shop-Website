  ...
  <head>
    ...
    <div id="wrapper"> <!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
      ...
      <div id="MainContent"> <!-- sets the main content (middle column area) -->
        ...
        <h2>Overview</h2>
        <p>The Student Shop has a Dimension Elite 3D printer which can perform <a href="https://en.wikipedia.org/wiki/Fused_deposition_modeling" rel="external">fused deposition modeling</a> with <acronym title="acrylonitrile butadiene styrene">ABS</acronym>. The machine is excellant for high quility rapid prototyping.</p>
        ...
        <ul>
          ...
          <li>Capable of printing support?: Yes</li>
