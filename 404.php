  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow">
      ...
      <!-- ****************************************************************************
           ...
           **********                                                     *************
           ****************************************************************************  -->
      <?php $subtitle = "404 Page not Found";?>
      ...
      <div id="wrapper" class="clear"> <!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
        ...
        <div id="MainContent"> <!-- sets the main content (middle column area) -->
          ...
          <h3>I've been looking for this drill like crazy so I can finish my class project!</h3>
          <p>We're sorry, it seems you tried to reach a page that is not currently on our servers.</p>
          <p>Please use our site navigation to find what you're looking for. Alternatively, you can search for content using our search box in header on top. If you wish you can also leave us some <a href="http://coestudentshop.engr.wisc.edu/about/feedback.php">feedback</a>.</p>
