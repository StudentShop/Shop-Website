  ...
  <head>
    ...
    <div id="wrapper"> <!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
      ...
      <div id="MainContent"> <!-- sets the main content (middle column area) -->
        ...
        <p>When a violation is committed an email warning notice will be sent out addressing the violation issue. The number of violations incurred within the <em>same year</em> will be dealt with according as follows:</p>
        <ul>
