        ...
        <?php require ($_SERVER['DOCUMENT_ROOT']."/main_nav.php"); ?>
          ...
          <div id="wrapper">
            ...
            <div id="MainContent">
              ...
              <h2><a name="materialsfee"></a>Materials Fee</h2>

              <p>All shop users (note exceptions listed below) are required to pay a biannual materials fee of $50 to use the Student Shop (i.e. $100 per user, per year). The first period extends from December 1<sup>st</sup> through June 30<sup>th</sup> and the second extends from June 1<sup>st</sup> through December 31<sup>st</sup> (allowing a one month overlap at the start and end of each fee period).</p>
              ...
              <p>Please log into EMU to <a href="https://emu.engr.wisc.edu/emu">pay the materials fee</a>.</p>
              ...
              <p>Individuals working on funded research are required to pay a biannual research fee of $100 to use the Student Shop (i.e. $200 per user, per year). The first period extends from December 1<sup>st</sup> through June 30<sup>th</sup> and the second extends from June 1<sup>st</sup> through December 31<sup>st</sup> (allowing a one month overlap at the start and end of each fee period).</p>
              ...
              <li>Individuals with a permit may check out hand tools (not including tooling, machine tools, or electric or pneumatic power tools) without paying the research fee.</li>
              <li>Enlisting shop services for hire (<a href="/capabilities/3dprint/index.php">3d printing</a>, <a href="/capabilities/instrshop/index.php">Instrument Shop</a>, etc.) does not require paying the research fee (nor even a permit).</li></ul>

              <h2><a name="feefaq"></a>Frequently Asked Questions</h2>
              <h3>How do I pay the materials fee?</h3>
              <p>To pay the materials fee, <a href="https://emu.engr.wisc.edu/emu">log into EMU</a> and click the button at the top of the screen that says "Pay Fee Now". You will need a credit card to pay. A debit card set up to work as a credit card will also work.</p>
