        ...
        <?php require ($_SERVER['DOCUMENT_ROOT']."/main_nav.php"); ?>
          ...
          <div id="wrapper">
            ...
            <div id="MainContent">
              ...
              <p>All shop users (note exceptions listed below) are required to pay a biannual materials fee of $50 to use the Student Shop (i.e. $100 per user, per year). The first period extends from December through June and the second extends from June through December (allowing a one month overlap at the start and end of each fee period).</p>
