...
**********															*************
*********************************************************************************	-->
				<?php $subtitle = "Woodworking 2 Seminar";?>
	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
	  ...
	  <h1>Woodworking 2 Seminar</h1>
        ...
        <h2>Prerequisites</h2>
        	...
        	<ul>
            	<li>Green or red permit</li>
                <li>Applied for the <a href="/permit/info/upgrades/woodworking_2.php">Woodworking 2 upgrade</a>&#42;</li>
            </ul>
            <p>&#42;Individuals will only be able to see upgrades in EMU for which they have completed the prerequisites.</p>

         <h2>Requirements</h2>
         	<ul>
            	<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Enroll in a woodworking 2 seminar</a>&#42;</li>
