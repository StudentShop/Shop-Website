...
**********															*************
*********************************************************************************	-->
				<?php $subtitle = "Welding 1 Seminar";?>
...
<div id="wrapper">		<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
	  ...
	  <h1>Welding 1 Seminar</h1>
      
      	<h2>Overview</h2>
        	<p>The welding 1 seminar is required to complete the welding 1 upgrade. This seminar will familiarize students with the safe operation and set-up of a plasma torch and a MIG welder. Students will also practice fillet, lap, and butt joints as well as plasma cutting.</p>
        ...
        <h2>Prerequisites</h2>
        	...
        	<ul>            	
                ...
                <li>Apply for the <a href="/permit/info/upgrades/welding_1.php">welding 1 upgrade</a>&#42;</li>
                <li>Complete the welding 1 quiz on <a href="https://special.moodle.wisc.edu/prod/course/view.php?id=67" rel="external">Moodle</a></li>
            </ul>
         ...
         <h2>Requirements</h2>    
            <ul>
            	<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Enroll in a welding 1 seminar</a>&#42;</li>
