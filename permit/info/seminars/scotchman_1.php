...
*********************************************************************************-->
		<?php $subtitle = "Scotchman 1 Seminar";?>
...
<div id="wrapper">	<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
		...
		<h1>Scotchman 1 Seminar</h1>
      
      		<h2>Overview</h2>
        		<p>The Scotchman 1 seminar is required to complete the Scotchman 1 upgrade. This seminar will familiarize students with the safe operation and set-up of the Scotchman ironworker.</p>
        	...
        	<h2>Duration</h2>
       		...
       		<h2>Prerequisites</h2>
        		...
        		<ul>            	
                		...
                		<li>Apply for the <a href="/permit/info/upgrades/scotchman_1.php">Scotchman 1 upgrade</a>&#42;</li>
                		<li>Complete the Scotchman 1 quiz on <a href="https://special.moodle.wisc.edu/prod/course/view.php?id=67" rel="external">Moodle</a></li>
            		</ul>
         	...
         	<h2>Requirements</h2>    
            		<ul>
            			<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Enroll in a Scotchman 1 seminar</a>&#42;</li>
