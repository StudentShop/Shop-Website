...
<div id="wrapper">		<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
    ...
    <h1>Red Permit</h1>
    	...
    	<h2>Overview</h2>
        	<p>The red permit is the mid-level permit. It is a good alternative to the green permit for students who do not wish to complete the addtional training on the mills and lathes but still need access to machines like drill presses, cutoff saws, and band saws.</p> 
            <p>All students in classes using the Student Shop must obtain a green permit (a red permit would <em>not</em> be an acceptable alternative) with the exception of InterEgr 160 which requires a red permit.</p>
        ...
        <img src="/permit/images/Application-Process-Red-Permit.png" alt="Application process for red permit. Application process takes about 1-2 weeks" align="middle" height="259px" width="710px"/>        
            ...
            <p><em><strong>Note: </strong>The process to obtain a red permit usually takes about 1-2 weeks but may take longer depending on the number of applicants applying, such as at the start and end of the semester. Please plan accordingly.</em></p>
        ...
        <h2>Privileges</h2>
        	<ul>
                ...
                <li>Use everything in the shop <em>except</em> the lathes and mills (which require a green permit) or equipment that requires an <a href="/permit/info/upgrades/index.php">upgrade</a></li>
             </ul>
		...
		<li><a href="/permit/info/upgrades/scotchman_1.php"<a>Scotchman 1 Upgrade</a> (Ironworker)</li>
            </ul>
