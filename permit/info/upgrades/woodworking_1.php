...
<div id="wrapper">		<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
	  ...
	  <h1>Woodworking 1 Upgrade</h1>
      	...
      	<h2>Overview</h2>
        	<p>The woodworking 1 upgrade is an additional amount of training individuals can take to learn how to safely use a variety of woodworking equipment (<a href="https://en.wikipedia.org/wiki/Table_saw" rel="external">table saw</a>, <a href="https://en.wikipedia.org/wiki/Panel_saw" rel="external">panel saw</a>, <a href="https://en.wikipedia.org/wiki/Circular_saw" rel="external">circular saw</a>, track saw, <a href="https://en.wikipedia.org/wiki/Miter_saw" rel="external">miter saw</a>, <a href="https://en.wikipedia.org/wiki/Biscuit_joiner" rel="external">biscuit joiner</a>, and <a href="https://en.wikipedia.org/wiki/Router_%28woodworking%29" rel="external">router</a>) in the Student Shop. Individuals will not be allowed to use this woodworking equipment until they have obtained the woodworking 1 upgrade.</p>
        ...
        <h2>Requirements</h2>
        	...
        	<ul>
                <li><a href="https://emu.engr.wisc.edu/emu" rel="external">Apply for the wood shop upgrade</a>&#42;</li>
