...
<div id="wrapper">		<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
	...
	<div id="leftNav">
		...
		<h2 class="subnav2"><span>Related Links</span></h2>
			<ul>
            	<li><a href="/permit/info/upgrades/cnc_mill_2.php">CNC Mill 2 Upgrade</a></li>
				<li><a href="/permit/info/upgrades/cnc_mill_4.php">CNC Mill 4 Upgrade</a></li>
            </ul>
	...
	<h1>CNC Mill 3 Upgrade</h1>
 	...
 	<h2>Overview</h2>
        ...
        <h2>Privileges</h2>
        	<ul>
          		<li>Three axis CNC machining on a machine of choice.</li>
        	</ul>
        	<p>Note: This only gives access to the machine choosen. To use one of the other machines you would need to go through this process again for that machine. You do not need to redraw your parts as long as you have them from your previous CNC Mill 3 upgrade.</p>
        ...
        <ul>
	  	...
	  	<li><a href="/permit/info/upgrades/cnc_mill_1.php">CNC Milling 1 Upgrade</a></li>
		<li><a href="/permit/info/upgrades/cnc_mill_2.php">CNC Milling 2 Upgrade</a>&#42;</li>
	</ul>
	<p>&#42;Machine choosen for CNC Mill 3 upgrade must be the same as machine used to complete CNC Mill 2 upgrade</p>
