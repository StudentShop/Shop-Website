...
**********															*************
*********************************************************************************	-->
	<?php $subtitle = "Waterjet 1 Upgrade";?>
				...
				<?php require ($_SERVER['DOCUMENT_ROOT']."/main_nav.php"); ?>
					...
					<div id="wrapper">
						...
						<div id="leftNav">
							...
							<?php require ($_SERVER['DOCUMENT_ROOT']."/permit/permit_left_nav.php") ?>
								...
								<ul>
									...
									<li><a href="/permit/info/upgrades/laser_1.php">Laser 1 Upgrade</a></li>
								</ul>
						...
						<div id="MainContent">
							...
							<h1>Waterjet 1 Upgrade</h1>

							<h2>Overview</h2>
							<p>The Waterjet 1 upgrade is an additional amount of training individuals can take to learn how to use a Prima LT 44 <a href="https://en.wikipedia.org/wiki/Water_jet_cutter" rel="external">waterjet</a>. Individuals will not be allowed to use the waterjet until they have obtained the Waterjet 1 upgrade.</p>

							<h2>Privileges</h2>
							<ul>
								<li>Use the Shop's waterjet</li>
							</ul>
							...
							<h2>Requirements</h2>
							<p>This training is currently in development and is therefore not yet available.</p>
							<!--<p>(must be completed in order)</p>
							<ul>
								<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Apply for the Waterjet 1 upgrade</a>&#42;</li>
