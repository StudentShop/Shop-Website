...
**********															*************
*********************************************************************************	-->
				<?php $subtitle = "Scotchman 1 Upgrade";?>
...
<div id="wrapper">		<!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
	  ...
	  <h1>Scotchman 1 Upgrade</h1>
      
      	<h2>Overview</h2>
        	<p>The Scotchman 1 upgrade is an additional amount of training individuals can take to learn how to safely setup and use the Scotchman ironworker. Individuals will not be allowed to use the Scotchman until they have obtained the Scotchman 1 upgrade.</p>
        
        <h2>Privileges</h2>
        	<ul>
            	<li>Use the Shop's Scotchman ironworker</li> 
            	</ul>
        ...
        <h2>Requirements</h2>
        	...
        	<ul>
            	<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Apply for the Scotchman 1 upgrade</a>&#42;</li>
                ...
                <li>Enroll in and attend the <a href="/permit/info/seminars/scotchman_1.php">Scotchman 1 seminar</a></li>
            </ul>
