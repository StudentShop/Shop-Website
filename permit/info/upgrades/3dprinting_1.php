...
**********															*************
*********************************************************************************	-->
	<?php $subtitle = "3D Printing 1 Upgrade";?>
				...
				<?php require ($_SERVER['DOCUMENT_ROOT']."/main_nav.php"); ?>
					...
					<div id="wrapper">
						...
						<div id="MainContent">
							...
							<h1>3D Printing 1 Upgrade</h1>

							<h2>Overview</h2>
							<p>The 3D printing 1 upgrade is an additional amount of training individuals can take to learn how to use a <a href="/capabilities/3dprint/reprap.php">Reprap 3D printer</a>. Individuals will not be allowed to use the Reprap until they have obtained
								the 3D printing 1 upgrade.</p>

							<h2>Privileges</h2>
							<ul>
								<li>Use the Shop's <a href="/capabilities/3dprint/reprap.php">Reprap 3D printer</a></li>
							</ul>
