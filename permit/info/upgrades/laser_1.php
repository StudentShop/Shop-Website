				...
				<?php require ($_SERVER['DOCUMENT_ROOT']."/main_nav.php"); ?>
					...
					<div id="wrapper">
						...
						<div id="MainContent">
							...
							<h2>Overview</h2>
							<p>The Laser 1 upgrade is an additional amount of training individuals can take to learn how to use a ULS laser cutter. Individuals will not be allowed to use the laser until they have obtained the Laser 1 upgrade.</p>
							...
							<h2>Prerequisites</h2>
							<ul>
								<li>Blue, red, or green permit</li>
							</ul>

							<h2>Requirements</h2>
							<p>(must be completed in order)</p>
							<ul>
							<li><a href="https://emu.engr.wisc.edu/emu" rel="external">Apply for the Laser 1 upgrade</a>&#42;</li>
