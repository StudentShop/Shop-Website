    ...
    <div id="wrapper">              <!-- wrapper sets the content area including the left nav, middle (main content), and right nav  -->
      ...
      <div id="leftNav">
        ...
        <ul>
          ...
          <li><a href="/permit/info/upgrades/cnc_mill_3.php">CNC Mill 3 Upgrade</a></li>
        </ul>
      ...
      <div id="MainContent"> <!-- sets the main content (middle column area) -->
        ...
        <h2>Privileges</h2>
        	<ul>
          		<li>Two axis CNC machining on a machine of choice.</li>
        	</ul>
        	<p>Note: This only gives access to the machine choosen. To use one of the other machines you would need to go through this process again for that machine. You do not need to redraw your parts as long as you have them from your previous CNC Mill 2 upgrade.</p>
