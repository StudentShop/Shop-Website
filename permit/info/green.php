	...
	<div id="MainContent"> <!-- sets the main content (middle column area) -->
	    ...
	    <h1>Green Permit</h1>
	    	...
	    	<h2>Overview</h2>
                ...
                <p>All students in classes using the Student Shop must obtain a green permit (a red permit would <em>not</em> be an acceptable alternative) with the exception of InterEgr 160 which requires a red permit. It is strongly recommend that individuals begin the process of getting a green permit as early as possible to avoid problems.</p>
           ...
           <img src="/permit/images/Application-Process-Green-Permit.png" alt="Application process for green permit. Application process takes about 2 weeks"  />
            ...
            <p><em><strong>Note: </strong>The process to obtain a green permit usually takes about 3 weeks but may take longer depending on the number of applicants applying, such as at the start or end of the semester. Please plan accordingly.</em></p>
        ...
        <h2>Privileges</h2>
        	<ul>
                ...
                <li>Use everything in the shop <em>except</em> equipment that requires an <a href="/permit/info/upgrades/index.php">upgrade</a></li>
             </ul>

        <h2>Requirements</h2>
        	<p>(must be completed in order)</p>
        	<ul>
            	<li><a href="/permit/application.php">Apply for a green shop permit</a></li>
                <li>Complete the green permit quizzes and exams on <a href="https://special.moodle.wisc.edu/prod/course/view.php?id=67" rel="external">Moodle</a></li>
                <li>Attend a <a href="/permit/info/seminars/green_seminar.php"> green permit seminar</a></li>
                <li>Complete the <a href="/permit/info/testpiece.php">test piece</a></li>
                <li>Come to the shop and have Student Shop staff create a permit for you</li>
            </ul>

         <h2>Time Frame and Deadlines</h2>
         	<ul>
            	<li>The green permit should take no longer than 3 weeks&#42; to complete.</li>
            ...
            <p>&#42; The process to obtain a green permit usually takes about 3 weeks but may take longer depending on the number of applicants applying, such as at the start or end of the semester. Please plan accordingly.</p>

            <h2>Upgrades&#42;</h2>
	        	<ul>
	        	    <li><a href="/permit/info/upgrades/woodworking_1.php">Woodworking 1 Upgrade</a> (Wood Saws)</li><br />
			    ...
			    <li><a href="/permit/info/upgrades/welding_3.php">Welding 3 Upgrades</a> (MIG Aluminum)</li>
                            <li><a href="/permit/info/upgrades/ironworker_1.php">Ironworker 1 Upgrade</a> (Ironworker)</li><br />
			    ...
			    <li><a href="/permit/info/upgrades/haas_1.php">HAAS 1 Upgrade</a> (HAAS: 3-Axis)<br /></li>
