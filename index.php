          ...
          <script type="text/javascript">
            var mygallery = new fadeSlideShow({
              ...
              imagearray: [
                ...
                ["/images/pictures_homepage/jebresearch.jpg", "", "", "Jeb Philips displays a friction stir welding tool that can transmit temperature data to aid research.", "Jeb Philips displays a friction stir welding tool that can transmit temperature data aid research."],               
